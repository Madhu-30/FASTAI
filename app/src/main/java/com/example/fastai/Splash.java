...
public class Splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPref sharedPref = new SharedPref(Splash.this);

//        if(isNetworkConnected(this)){
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                        Intent homeIntent = new Intent(com.example.fastai.Splash.this, MainActivity.class);
...
//    private boolean isNetworkConnected(com.example.fastai.Splash context) {
//
